...
std::shared_ptr<Ghost> EasyMobGenerator::createGhost() {
    ...
    ghost->setColor();
    ghost->attack_data_ = AttackData{
            .damage = 15,
            .default_damage = 15,
            .attack_radius = 125,
            .default_attack_radius = 125};
...
std::shared_ptr<Knight> EasyMobGenerator::createKnight() {
    ...
    knight->setColor();
    knight->item_ = MapBuilder::createItem(BUG + "axe.png",
                                           {MOB_WEAPON_POS_X, MOB_WEAPON_POS_Y},
                                           {10, 0, 100, 0, ECS::ITEM_ID::WEAPON});
    knight->attack_data_ = AttackData{
            .damage = knight->item_.data_.damage,
