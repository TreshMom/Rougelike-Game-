...
constexpr float PLAYER_START_X = WORLD_WIDTH / 1.5 - SPRITE_SIZE;
constexpr float PLAYER_START_Y = WORLD_HEIGHT / 1.5 - SPRITE_SIZE;

constexpr float MOB_SPAWN_X = WORLD_WIDTH / 1.5;
constexpr float MOB_SPAWN_Y = WORLD_HEIGHT / 1.5;
